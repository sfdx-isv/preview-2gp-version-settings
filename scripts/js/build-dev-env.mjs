...
export async function buildDevEnv() {
  ...
  //*/
  /*
  // STEP FOUR: Install package dependendencies in the new scratch org.
  //*/
    // TODO: Add implementation
  //*
  // STEP FIVE: Push project source to the new scratch org.
  tr.addTask(new SfdxTask(
  ...
  //*/
  // STEP SIX: Assign "All Access" permission sets to the Dev/Test admin user.
  tr.addTask(new SfdxTask(
